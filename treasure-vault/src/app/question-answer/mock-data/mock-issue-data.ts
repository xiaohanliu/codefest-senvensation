...
export const MockAnswers: IBase[] = [{id: "02", author: "ZedLepplin", createdDate: new Date(), updatedDate: new Date(), description: "You suck!!!", title: "Lame title" , upCount: 1, downCount: 85, tags:["angular","mock","spy"], parentId: "01"}]
